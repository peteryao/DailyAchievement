from gamify.models import Quest, CompleteQuest, Interest, UserInterests, UserAdditions, Rank, Flair, Achievement, Trophy, UserAchievement, UserTrophy, ActiveQuest, Competition, Group, UserGroup
...
class UserAdditionsAdmin(admin.ModelAdmin):
    list_display = ('user', 'exp', 'points', 'completed', 'occupation', 'avatar', 'location', 'rank', 'flair')
